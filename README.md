...
Custom Redux/Zustand-like state management library.

## 🚀 Overview
This repository contains a professional implementation of **TS State Manager**. It is designed with clean code principles and focuses on functionality and reliability.
...
### Installation
```bash
git clone https://github.com/skylerblue333/TS-State-Manager.git
cd TS-State-Manager
```
